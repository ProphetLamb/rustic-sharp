...
public sealed class ILEmitter {
    ...
    public ILEmitter bne_un(Label target) {
        Gen.Emit(OpCodes.Bne_Un, target);
        return this;
    }

    public ILEmitter beq(Label target) {
        Gen.Emit(OpCodes.Beq, target);
        return this;
    }
    ...
    public ILEmitter ldc_r4(float c) {
        Gen.Emit(OpCodes.Ldc_R4, c);
        return this;
    }

    public ILEmitter ldc_r8(double c) {
        Gen.Emit(OpCodes.Ldc_R8, c);
        return this;
    }
    ...
    public ILEmitter ldloc_s(int idx) {
        Gen.Emit(OpCodes.Ldloc_S, idx);
        return this;
    }

    public ILEmitter ldloc_s(LocalBuilder local) {
        Gen.Emit(OpCodes.Ldloc_S, local);
        return this;
    }
    ...
    public unsafe ILEmitter perform(delegate*<ILEmitter, MemberInfo, void> action, MemberInfo member) {
        action(this, member);
        return this;
    }
