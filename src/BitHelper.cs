...
namespace HeaplessUtility
{
    public static class BitHelper
    {
        ...
        private static ReadOnlySpan<byte> MultiplyDeBruijnBitPosition2 => new byte[32]
        {
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint FastRange(this uint value, uint maximum)
        {
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint HasAlignedZeroByte(this uint value) => (value - 0x01010101u) & ~value & 0x80808080u;

        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong HasAlignedZeroByte(this ulong value) => (value - 0x0101010101010101ul) & ~value & 0x8080808080808080ul;
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint Max(this uint x, uint y)
        {
            Debug.Assert(Math.Abs(x) == x && Math.Abs(y) == y);
            return x - ((x - y) & ((x - y) >> 31));
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint Min(this uint x, uint y)
        {
            Debug.Assert(Math.Abs(x) == x && Math.Abs(y) == y);
            return y + ((x - y) & ((x - y) >> 31));
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong Max(this ulong x, ulong y)
        {
            return x - ((x - y) & ((x - y) >> 63));
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong Min(this ulong x, ulong y)
        {
            return y + ((x - y) & ((x - y) >> 63));
        }
