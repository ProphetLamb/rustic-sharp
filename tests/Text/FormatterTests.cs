...
public class FormatterTests {
    ...
    public static IEnumerable<object[]> NamedFormatTestCases = new List<object[]> {
        ...
        new object[] {
            "{foo} {bar}", new Dictionary<string, string> {["foo"] = "Hello", ["bar"] = "World",}, "Hello World",
        },
        new object[] {
            "{foo}{bar}{boo}",
            new Dictionary<string, string> {["foo"] = "Hello", ["bar"] = " ", ["boo"] = "World",},
            "Hello World",
        },
        new object[] {
            "{bar}{foo}{boo}",
            new Dictionary<string, string> {["foo"] = " ", ["bar"] = "Hello", ["boo"] = "World",},
            "Hello World",
        },
